...
int main()
{
	...
	*/
	IAnimatedMesh* mesh = smgr->getMesh("/Users/vicostudio/Documents/Shared/TEK2/CPP/cpp_indie_studio/lib/irrlicht-1.8.4/media/sydney.md2");
	if (!mesh)
	{
		device->drop();
		return 1;
	...
	*/
	if (node)
	{
		...
		node->setMaterialTexture( 0, driver->getTexture("/Users/vicostudio/Documents/Shared/TEK2/CPP/cpp_indie_studio/lib/irrlicht-1.8.4/media/sydney.md2") );
	}
