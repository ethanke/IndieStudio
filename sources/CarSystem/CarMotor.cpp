...
// Last update Mon May 15 11:29:52 2017 Sousa Victor
//
...
void CarMotor::OnFrame(int inputX, int inputY) {
    if (this->_debug && this->_gui != NULL) {
        this->_inputGui->setText(Utils::StrToWstr(std::string("intput,  X: " + std::to_string(inputX) + std::string(",  Y: ") + std::to_string(inputY))));
    }
}
