...
// Last update Sat May 13 00:25:50 2017 Sousa Victor
//
...
void IndieGame::loadMap() {
    ...
    ILiquidBody* water = _world->addLiquidBody(irr::core::vector3df(-5000,0,5000),irr::core::aabbox3df(0, -10000, 0, 100\
00, 0, 10000), 500.0f, 200.0f);
    ...
    irr::scene::IAnimatedMesh* mesh = _device->getSceneManager()->addHillPlaneMesh( "myHill",
        ...
        irr::scene::ISceneNode* node = _device->getSceneManager()->addWaterSurfaceSceneNode(mesh->getMesh(0), 0.0f, 300.0\
f, 30.0f);
