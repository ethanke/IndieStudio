...
// Last update Fri May 12 18:17:21 2017 Sousa Victor
//
...
void IndieGame::loadMap() {
    ...
    node_road->setMaterialFlag(irr::video::EMF_LIGHTING, false);
    ...
    node_road2->setMaterialFlag(irr::video::EMF_LIGHTING, false);
